...
async def main():
    ...
    if not os.path.exists('dados/tweets-dou.json'):
    ...
    dirName = 'dados/tweets-enviados-dou/'
    ...
    with open('dados/tweets-dou.json') as f:
        ...
        for tweet in tweets:
            ...
            try:
                ...
                text_no_emoji = normalize_tweets.removeNone(text)
                text_no_emoji = normalize_tweets.removeEmoji(text_no_emoji)
